...
<body>
    ...
    @include('parts.nav')
    <main>
        <h2>Potwierdź usunięcie użytkownika</h2>
        <form action="<?= config('app.url') ?>/users/delete/{{ $user->id }}" method="post" class="form-inline">
            @csrf
            <p>
            ...
            <p>
                ...
                <select name="usertype" id="usertype" disabled="disabled">
